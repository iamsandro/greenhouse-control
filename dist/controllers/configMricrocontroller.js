...
const configMicro_1 = __importDefault(require("../models/configMicro"));
const getConfigMicro = (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const configMicroList = yield configMicro_1.default.find();
...
const createConfigMicro = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const newConfigMicro = yield configMicro_1.default.create(req.body);
